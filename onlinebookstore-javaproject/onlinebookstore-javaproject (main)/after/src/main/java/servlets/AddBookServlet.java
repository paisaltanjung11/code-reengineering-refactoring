...
/**
 * Servlet for adding new books to the inventory
...
public class AddBookServlet extends HttpServlet {
    ...
    public void service(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        // If no book name provided, show the form
    ...
    /**
     * Process the add book request with form data
     */
    ...
    /**
     * Create a Book object from request parameters
     */
