...
public class CartServlet extends HttpServlet {
    ...
    public void service(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        try {
            ...
            pw.println("<table class=\"table table-hover\" style='background-color:white'>\r\n"
                    ...
                    + "  </thead>\r\n"
                    + "  <tbody>\r\n");
            double amountToPay = calculateCartTotal(session, books, cartItems, pw);
            ...
            if (amountToPay > 0) {
                pw.println("    <tr style='background-color:green'>\r\n"
                        ...
                        + "      <td colspan='1' style='color:white; font-weight:bold'><span>&#8377;</span> " + amountToPay
                        + "</td>\r\n"
                        + "    </tr>\r\n");
            }
            pw.println("  </tbody>\r\n"
            ...
            if (amountToPay > 0) {
                pw.println("<div style='text-align:right; margin-right:20px;'>\r\n"
                        ...
                        + "<input type='submit' class=\"btn btn-primary\" name='pay' value='Proceed to Pay &#8377; " + amountToPay + "'/></form>"
                        + "    </div>");
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void updateCartItems(HttpServletRequest req) {
    ...
    private double calculateCartTotal(HttpSession session, List<Book> books, List<Cart> cartItems, PrintWriter pw) {
