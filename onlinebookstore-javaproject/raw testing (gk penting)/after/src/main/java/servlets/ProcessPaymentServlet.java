...
public class ProcessPaymentServlet extends HttpServlet {
    ...
    public void service(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        try {
            includeCustomerHome(req, res, pw);
            List<Cart> cartItems = getCartItemsFromSession(req.getSession());
            processCartItems(cartItems, pw, req.getSession());
            clearSessionAttributes(req.getSession(), pw);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

    private boolean isCustomerLoggedIn(HttpServletRequest req) {
        return StoreUtil.isLoggedIn(UserRole.CUSTOMER, req.getSession());
    }
    ...
    private void includeCustomerHome(HttpServletRequest req, HttpServletResponse res, PrintWriter pw) throws ServletException, IOException {
    ...
    private List<Cart> getCartItemsFromSession(HttpSession session) {
    ...
    private void processCartItems(List<Cart> cartItems, PrintWriter pw, HttpSession session) {
    ...
    private void clearSessionAttributes(HttpSession session, PrintWriter pw) {
