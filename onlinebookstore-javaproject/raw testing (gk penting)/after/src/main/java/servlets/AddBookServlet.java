...
public class AddBookServlet extends HttpServlet {
    ...
    public void service(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        if (isBookNameInvalid(bName)) {
            showAddBookForm(pw);
            return;
        }

        processAddBook(req, pw, bName);
    }

    private boolean isSellerLoggedIn(HttpServletRequest req) {
        return StoreUtil.isLoggedIn(UserRole.SELLER, req.getSession());
    }
    ...
    private boolean isBookNameInvalid(String bName) {
        return bName == null || bName.trim().isEmpty();
    }

    private void processAddBook(HttpServletRequest req, PrintWriter pw, String bName) {
        try {
